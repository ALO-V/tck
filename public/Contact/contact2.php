<?php
//configs
$email_to ='test@test.com'; //put your email address here
$email_subject_prefix ='Test'; //put the email sibject line prefix here
$email_from ='server@yourserver.com'; //put the email address that this form will be sent from
$email_from_nice ='Dan'; //put in the 'nice' name for the email sender
